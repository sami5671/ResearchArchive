                ...
                <?php foreach ($blogs as $blog): ?>
                    <div class="bg-white shadow-lg rounded-lg p-6 border border-gray-200 transition-all duration-300 ease-in-out transform hover:shadow-2xl hover:scale-105">
                        ...
                        <div class="text-right">
                            <a href="view_blog_details.php?id=<?php echo $blog['id']; ?>" class="bg-blue-600 text-white px-6 py-2 rounded-lg font-medium hover:bg-blue-700 transition-colors duration-300">
                                Read More
                            </a>
                        </div>
